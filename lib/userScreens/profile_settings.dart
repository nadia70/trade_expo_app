...
class ExpoProfileSettings extends StatefulWidget {
  @override
  _ExpoDeliveryAddress createState() => new _ExpoDeliveryAddress();
}

class _ExpoDeliveryAddress extends State<ExpoProfileSettings> {
              ...
              children: <Widget>[
                ...
                new Container(
                  ...
                  child: new TextFormField(
                    ...
                    style:
                    new TextStyle(color: Colors.blueAccent, fontSize: 18.0),
